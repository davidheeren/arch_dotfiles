...
function utilities.parse_color(color)
    ...
    if not color:find("#") and color ~= "NONE" then
        -- color = require("colorscheme.palette_local")[color] or vim.api.nvim_get_color_by_name(color)
        color = require("colorscheme.colors")[color] or vim.api.nvim_get_color_by_name(color)
    end
