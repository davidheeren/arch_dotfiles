...
hl.bind(main_mod .. " + SHIFT + F", hl.dsp.window.float({ action = "toggle" }), { description = "Toggle floating window" })
hl.bind(main_mod .. " + SPACE", hl.dsp.exec_cmd("~/bin/process-toggle wofi -aI -S drun -p app"), { description = "Open app" })
hl.bind(main_mod .. " + SHIFT + P", hl.dsp.window.pin(), { description = "Toggle pin window across workspaces" })
hl.bind(main_mod .. " + SHIFT + T", hl.dsp.window.set_prop({ prop = "opaque", value = "toggle", window = "active" }),
